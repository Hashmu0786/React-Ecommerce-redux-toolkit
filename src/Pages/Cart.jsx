...
import { removeFromCart, selectTotalPrice } from "../store/cartSice";
                            ...
                            {cart.length === 0 ? (
                                ...
                                <div className="flow-root">
                                        ...
                                        {cart.map((item, index) => (
                                            <li key={index} className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                                                <div className="shrink-0 relative">
                                                    ...
                                                    <img className="h-24 w-24 max-w-full rounded-lg object-cover" src={item.thumbnail} alt={item.title} />
                                                </div>
                                    ...
                                    <div className="mt-6 flex items-center justify-between">
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900"><span className="text-xs font-normal text-gray-400">USD</span> ${(total + 8).toFixed(2)}</p>
                                    </div>
